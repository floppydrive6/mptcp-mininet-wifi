...
def topology(pathmanager, scheduler):
    ...
    ap2 = net.addAccessPoint('ap2', mac='00:00:00:00:00:02', equipmentModel='TLWR740N',
                             protocols='OpenFlow10', ssid='ssid_ap2', mode='g', channel='1', position='55,20,0')
    ap3 = net.addAccessPoint('ap3', mac='00:00:00:00:00:03', equipmentModel='TLWR740N',
                             protocols='OpenFlow10', ssid='ssid_ap3', mode='g', channel='6', position='50,11,0')
    ...
    h10.cmd('iperf -s -i 1 > testmodes/' + FOLDER_NAME +
            '/server/server_' + name_postfix + '.log &')
    sta1.cmd('iperf -c 192.168.1.254 -t 45 -i 1 > testmodes/' + FOLDER_NAME + '/client/iperf/client_' +
             name_postfix + '.log 2>&1 &')
    sta1.cmd('ifstat -b > testmodes/' + FOLDER_NAME + '/client/ifstat/ifstat_' +
             name_postfix + '.log 2>&1 &')
    ...
    sta1.cmd('cat ' + proc_path + ' > testmodes/' + FOLDER_NAME + '/client/proc/proc_' +
             name_postfix + '.log')
