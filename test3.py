...
def topology(pathmanager, scheduler):
    ...
    ap2 = net.addAccessPoint('ap2', mac='00:00:00:00:00:02', protocols='OpenFlow10', ssid='ssid_ap2', mode='n', channel='1', position='55,20,0', equipmentModel='TLWR740N')
    ap3 = net.addAccessPoint('ap3', mac='00:00:00:00:00:03', protocols='OpenFlow10', ssid='ssid_ap3', mode='n', channel='6', position='50,10,0', equipmentModel='TLWR740N')
    ...
    c11 = net.addController('c11', controller=Controller, ip='127.0.0.1')
    ...
    net.addLink(s9, h4, bw=1000)
    net.addLink(s9, h5, bw=1000)  #
