...
def topology():
    ...
    net.addLink(ap2, h4, bw=1000)  # to do: TEST for 1000 Mbits/s BW
    ...
    sta1.cmd('ping 192.168.1.254 -c 3')

    sleep(5)

    h10.cmd('iperf -s > testcmd/server &')
    sta1.cmd('iperf -c 192.168.1.254 -t 5 > testcmd/client &')
    sleep(3)
