...
from mininet.node import RemoteController, OVSKernelSwitch, UserAP
...
def topology(pathmanager, scheduler):
    ...
    net = Mininet(controller=RemoteController,
                  link=TCLink, switch=OVSKernelSwitch, accessPoint=UserAP)
    net.start()
    ...
    #                          protocols='OpenFlow10', ssid='ssid_ap3', mode='n', channel='11', position='50,11,0')
    ap2 = net.addAccessPoint('ap2', mac='00:00:00:00:00:02', protocols='OpenFlow10', ssid='ssid_ap2', mode='n', channel='1', position='55,20,0')
    ap3 = net.addAccessPoint('ap3', mac='00:00:00:00:00:03', protocols='OpenFlow10', ssid='ssid_ap3', mode='n', channel='11', position='50,11,0')
