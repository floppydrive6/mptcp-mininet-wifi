...
def topology(pathmanager, scheduler):
    ...
    # ap2 = net.addAccessPoint('ap2', mac='00:00:00:00:00:02', protocols='OpenFlow10', ssid='ssid_ap2', mode='g', channel='1', position='55,20,0')
    # ap3 = net.addAccessPoint('ap3', mac='00:00:00:00:00:03', protocols='OpenFlow10', ssid='ssid_ap3', mode='g', channel='11', position='50,11,0')
